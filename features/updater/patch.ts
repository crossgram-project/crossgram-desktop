...
function keyHeader(privateKey: string): string {
  return [
...
function alphaKeyHeader(): string {
  return [
    "// Generated by the Crossgram updater feature; never committed.",
...
async function installPackerKeys(
  ...
  await writeFile(target, keyHeader(privateKey), "utf8");
  if (packerSource.includes('"../../../../DesktopPrivate/alpha_private.h"')) {
